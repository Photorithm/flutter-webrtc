...
public class RTCAudioManager {
  ...
  public void updateAudioDeviceState() {
    ...
    if (bluetoothManager.getState() == RTCBluetoothManager.State.HEADSET_AVAILABLE
        || bluetoothManager.getState() == RTCBluetoothManager.State.HEADSET_UNAVAILABLE
        || bluetoothManager.getState() == RTCBluetoothManager.State.SCO_DISCONNECTING) {
    ...
    if (bluetoothManager.getState() == RTCBluetoothManager.State.SCO_CONNECTED
